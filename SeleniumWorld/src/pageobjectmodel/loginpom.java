...
public class loginpom {
	...
	WebElement firstNameTxt2;                 
	WebElement lastNameTxt2;                 
	WebElement genderRdBtn;                          
	WebElement yearsOfExperienceRadBtn;               
	WebElement datePickerTxtBx;              
	WebElement favouriteTeaChkbox;            
	WebElement aboutTeaChkbox;                  
	WebElement continentsDropdwn;         
	WebElement endOfOrderingTea;              
